...
<<<<<<< HEAD
export default function Navbar({ cartCount, favoritesCount, onLoginClick, onCartClick, onFavoritesClick }) {
  return (
...
>>>>>>> 8755c60e0273a4000dc6af5176f07a1757b61c1e
      ...
      <div className="flex items-center space-x-6 absolute right-8 top-1.5 p-4">
        ...
        <button className="text-white hover:text-gray-600" onClick={onLoginClick}>
          Login/Signup
        </button>
      </div>
    </div>
